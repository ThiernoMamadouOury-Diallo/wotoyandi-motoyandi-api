package fr.wotoyandi.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "fr.wotoyandi.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "fr.wotoyandi.model" });
